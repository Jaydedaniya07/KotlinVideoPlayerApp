package com.app.jdvideoplayer.repository

import android.app.Activity
import androidx.lifecycle.MutableLiveData
import com.app.jdvideoplayer.model.DemoClass
import com.app.jdvideoplayer.webServices.ApiServices
import com.app.jdvideoplayer.webServices.RetrofitClient
import okhttp3.ResponseBody
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class MainRepository(val activity: Activity) {
    ...
    fun getData(hashMap: HashMap<String, Any>): MutableLiveData<DemoClass> {

        val userData: MutableLiveData<DemoClass> = MutableLiveData()
        val request = apiServices.getData(hashMap)
